...
export default function StageUpgrades({campaign,hull,onChoose}:{campaign:Campaign;hull:Hull;onChoose:(kind:Upgrade|'continue')=>void}){
 ...
 </div><small>Upgrades apply to every ship for this play session.</small></div>;
}
